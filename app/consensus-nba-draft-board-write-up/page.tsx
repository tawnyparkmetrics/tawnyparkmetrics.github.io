    ...
    return (
        <div className="overflow-x-auto my-4">
            <table className="w-full border-collapse">
                ...
                <tbody>
                    {[
                        ['2025', '290', '121', '9519', '167', '57.0'],
                        ['2024', '178', '105', '6608', '115', '57.5'],
                        ['2023', '176', '115', '4544', '74', '61.4'],
                        ['2022', '178', '118', '6434', '100', '64.3'],
                        ['2021', '150', '116', '6954', '105', '66.2'],
                        ['2020', '192', '128', '4185', '63', '66.4']
                    ].map((row, index) => (
